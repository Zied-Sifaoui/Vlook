    ...
    if result.face_landmarks:
        for face_landmarks in result.face_landmarks:
            ...
            for upper_idx, lower_idx in [
                ...
                frame = draw_rounded_brow(frame, upper_pts, lower_pts, DARK_BROWN)

    cv2.putText(frame, "Style: Rounded (Soft/Feminine) | Dark Brown", (10, 28),
                cv2.FONT_HERSHEY_SIMPLEX, 0.55, (255, 255, 255), 1, cv2.LINE_AA)
    cv2.imshow("Rounded Brow - Dark Brown", frame)
