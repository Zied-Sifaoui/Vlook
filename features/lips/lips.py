...
# ==========================================
# 📦 Auto Download Face Landmarker Model
# ==========================================
...
# ==========================================
# 💋 Lip-Only Enlargement (No Face Distortion)
# ==========================================    
def enlarge_lips(frame, landmarks, strength=0.4):
    h, w = frame.shape[:2]

    # Outer lip contour (MediaPipe FaceMesh)
    lip_indices = [
